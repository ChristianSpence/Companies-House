...
- [BasicCompanyData - CREATE TABLE.sql](https://github.com/ChristianSpence/Companies-House/blob/main/BasicCompanyData-CREATE TABLE.sql) provides SQL Server commands to create a table according to the Companies House schema
